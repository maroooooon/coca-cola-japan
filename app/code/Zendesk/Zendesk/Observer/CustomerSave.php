...
class CustomerSave extends Base
{
    ...
    const updateTitle = "customer updated";
    const createTitle = "customer created";
    /**
    ...
    {
        $customer = $this->observer->getCustomer();
//        if the customer was created at the same time it was updated, then the customer was just created. Otherwise, it was just updated.

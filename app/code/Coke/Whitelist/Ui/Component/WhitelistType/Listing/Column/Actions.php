...
namespace Coke\Whitelist\Ui\Component\WhitelistType\Listing\Column;
...
class Actions extends Column
{
    ...
    {
        return $this->urlBuilder->getUrl('coke_whitelist/types/edit', [
            'id' => $item[$idField]
        ]);
    }
    ...
    {
        return $this->urlBuilder->getUrl('coke_whitelist/types/delete', [
            'id' => $item[$idField]
        ]);
    }

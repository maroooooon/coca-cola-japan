...
class AddLabelMaxWidthAttribute implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $eavSetup->addAttribute('catalog_product', 'label_max_width', [
            'type' => 'int',
            'label' => 'Personalized Bottle Label Max Width',
            'input' => 'text',
            'user_defined' => true,
            'required' => false
        ]);

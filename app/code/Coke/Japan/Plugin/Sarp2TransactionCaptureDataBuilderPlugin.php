...
class Sarp2TransactionCaptureDataBuilderPlugin
{
    /**
     * @var LoggerInterface
     */
    ...
    /**
     * @param \Aheadworks\Sarp2Stripe\Gateway\Request\TransactionCaptureDataBuilder $subject
     * @param array $buildSubject
     * @return array[]
     * @throws NoSuchEntityException
     */
    public function beforeBuild(
        \Aheadworks\Sarp2Stripe\Gateway\Request\TransactionCaptureDataBuilder $subject,
        array $buildSubject
    ) {

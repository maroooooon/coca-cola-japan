...
class QuestionnaireReminderIdentity extends Container implements IdentityInterface
{
    ...
    const XML_PATH_EMAIL_ENABLED = 'sales_email/questionnaire_reminder/enabled';

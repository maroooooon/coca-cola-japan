...
use Coke\CompletedOrderQuestionnaire\Model\Email\Container\Order\CouponReminderIdentity;
...
class CouponReminderSender extends Sender
{
    /**
     * CouponReminderSender constructor.
     * @param Context $context
     * @param LoggerInterface $logger
     * @param TransportBuilder $transportBuilder
     * @param CouponReminderIdentity $identityContainer
    ...
    public function __construct(
        ...
        CouponReminderIdentity $identityContainer,

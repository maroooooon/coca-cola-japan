...
class UpdateBelgiumLuxembourgFrenchPersonalizeResolutionOptions implements DataPatchInterface
{
    /**
     * @var LoggerInterface
     */
    ...
    {
        $this->updateTitleAndSortOrder('De', 'Pour');
        $this->updateTitleAndSortOrder('à', 'De');
     ...
     */
    private function updateTitleAndSortOrder(string $title, string $newTitle, int $sortOrder = null)
    {
        $storeId = $this->getStoreIdByCode('belgium_luxembourg_french');

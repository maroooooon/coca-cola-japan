...
class UpdateTurkishPersonalizeResolutionOptionsV2 implements DataPatchInterface
{
    /**
     * @var LoggerInterface
     */
    ...
    {
        $this->updateTitleAndSortOrder('From', 'Kimden');
        $this->updateTitleAndSortOrder('To', 'Kime');

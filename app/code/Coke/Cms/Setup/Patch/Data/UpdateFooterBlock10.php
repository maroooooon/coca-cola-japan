...
class UpdateFooterBlock10 implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $block->setIdentifier('footer_links_block_ar');
        $block->setContent($this->contentUpgrader->getContentFile('blocks', 'footer_links_block_ar'));
        $block->setTitle('Footer Links Block Arabic');
        ...
        $widget->setTitle('Arabic Footer Links')

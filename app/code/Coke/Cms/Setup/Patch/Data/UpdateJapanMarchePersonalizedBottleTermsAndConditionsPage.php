...
class UpdateJapanMarchePersonalizedBottleTermsAndConditionsPage implements \Magento\Framework\Setup\Patch\DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $this->contentUpgrader->upgradePagesByStoreView([
            'marche_personalized_bottle_terms_and_conditions' => [
                'title' => 'マイラベルサービス規約',
                'content_heading' => 'マイラベルサービス規約',
                'identifier' => 'personalized-terms-conditions',

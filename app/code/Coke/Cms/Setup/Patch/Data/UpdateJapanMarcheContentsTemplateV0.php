...
class UpdateJapanMarcheContentsTemplateV0 implements \Magento\Framework\Setup\Patch\DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        // title must match on environment else causes error.
        $this->contentUpgrader->upgradePagesByStoreView([
            'marche_contents_template' => [
                'title' => 'Japan Marche Contents Template',
                'content_heading' => '',
                'identifier' => 'marche-contents-template',

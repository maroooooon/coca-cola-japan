...
class CreateTopoChicoGreeceHomePage implements \Magento\Framework\Setup\Patch\DataPatchInterface
{
    /**
    ...
    protected function createCmsPages($engStore, $grStore)
    {
        ...
        $pageEng->setIdentifier('home');
        $pageEng->setTitle('TopoChico Greece Homepage - Eng');
        ...
        $pageGr->setIdentifier('home');
        $pageGr->setTitle('TopoChico Greece Homepage - Gr');

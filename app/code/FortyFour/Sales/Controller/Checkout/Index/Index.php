...
namespace FortyFour\Sales\Controller\Checkout\Index;
...
class Index extends \Magento\Checkout\Controller\Onepage implements HttpGetActionInterface
{
    ...
    public function execute()
    {
        ...
        if (!$quote->hasItems() || $quote->getHasError() || !$quote->validateMinimumAmount() || !$this->validateMaximumAmount->validate($quote)) {
            return $this->resultRedirectFactory->create()->setPath('checkout/cart');
        }

...
return [
    ...
    'modules' => [
        ...
        'CokeEgypt_Customer' => 0,
        'CokeEurope_AddressAutocomplete' => 0,
        'CokeEurope_AgeRestriction' => 0,
        'CokeEurope_Catalog' => 0,
        'Coke_Cds' => 1,
        'Coke_Delivery' => 1,
        'CokeEurope_ContactModal' => 0,
        'CokeEurope_Currency' => 0,
        'CokeEurope_Customer' => 0,
        'CokeEurope_DataLayer' => 0,
        'Coke_Cms' => 1,
        'CokeEurope_NorthernIrelandVerification' => 0,
        'CokeEurope_PersonalizedProduct' => 0,
        'CokeEurope_ProductPopularity' => 0,
        'CokeEurope_StoreModifications' => 0,
        'CokeEurope_Stripe' => 0,
        'CokeEurope_Tax' => 0,
        'CokeEurope_Validations' => 0,
